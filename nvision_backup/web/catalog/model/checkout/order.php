  ...
  class ModelCheckoutOrder extends Model {	
    ...
    public function confirm($order_id, $order_status_id, $comment = '', $notify = false) {
      ...
      if ($order_info && !$order_info['order_status_id']) {
        ...
        $template->data['link'] = HTTP_SERVER . 'index.php?route=account/order/info&order_id=' . $order_id;
        
        if ($order_download_query->num_rows) {
          $template->data['download'] = HTTP_SERVER . 'index.php?route=account/download';
          } else {
        ...
        if ($order_info['customer_id']) {
          ...
          $text .= HTTP_SERVER . 'index.php?route=account/order/info&order_id=' . $order_id . "\n\n";
        }
        
        if ($order_download_query->num_rows) {
          $text .= $language->get('text_new_download') . "\n";
          $text .= HTTP_SERVER . 'index.php?route=account/download' . "\n\n";
        }
