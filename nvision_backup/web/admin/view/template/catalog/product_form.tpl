      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <input type="hidden" name="quantity" value="99999" size="5" />				
				<tr>
              <td>Стандартное количество добавления в корзину:</td>
              <td><input type="text" name="default_quantity" value="<?php echo $default_quantity; ?>" size="4" /></td>
            </tr>
