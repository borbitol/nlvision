...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="vtabs" class="vtabs"><a href="#tab-customer"><?php echo $tab_customer; ?></a><a href="#tab-product"><?php echo $tab_product; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-customer" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              <td class="left">Стандарт:</td>
              <td class="left"><select name="standard">
                <?php foreach ($standards as $foreach_standard) { ?>
                  <?php if ($foreach_standard == $standard) { ?>
                    <option value="<?php echo $foreach_standard; ?>" selected="selected"><?php echo $foreach_standard; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $foreach_standard; ?>"><?php echo $foreach_standard; ?></option>
                  <?php } ?>
                <?php } ?>
              </select></td>
            </tr>
            ...
            <tr>
              <td class="left">Требуется техническая помощь:</td>
              <td class="left"><select name="need_assistance">
          ...
          <table class="list">
            <thead>
              <tr>
                ...
                <td class="left" style="display:none;"><?php echo $column_model; ?></td>
      ...
      success: function(json) {
        ...
        if (json['order_product'] != '') {
          ...
          for (i = 0; i < json['order_product'].length; i++) {
            ...
            html += '  </td>';
            html += '  <td class="left" style="display:none;">' + product['model'] + '<input type="hidden" name="order_product[' + product_row + '][model]" value="' + product['model'] + '" /></td>';
            html += '  <td class="left">' + product['quantity'] + '<input type="hidden" name="order_product[' + product_row + '][quantity]" value="' + product['quantity'] + '" /></td>';
            html += '  <td class="right" style="display:none;">' + product['price'] + '<input type="hidden" name="order_product[' + product_row + '][price]" value="' + product['price'] + '" /></td>';
            html += '  <td class="right" style="display:none;">' + product['total'] + '<input type="hidden" name="order_product[' + product_row + '][total]" value="' + product['total'] + '" /><input type="hidden" name="order_product[' + product_row + '][tax]" value="' + product['tax'] + '" /><input type="hidden" name="order_product[' + product_row + '][reward]" value="' + product['reward'] + '" /></td>';
            html += '</tr>';
