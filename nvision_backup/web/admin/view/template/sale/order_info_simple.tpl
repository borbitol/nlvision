  ...
  <div class="box">
    ...
    <div class="content">
      <div class="vtabs"><a href="#tab-order"><?php echo $tab_order; ?></a><!--<a href="#tab-payment"><?php echo $tab_payment; ?></a>-->
        ...
        <a href="#tab-shipping" style="display:none;"><?php echo $tab_shipping; ?></a>
        <?php } ?>
      ...
      <div id="tab-order" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            <td>Требуется техническая помощь:</td>
            <td><?php echo ($need_assistance) ? $this->language->get('text_yes') : $this->language->get('text_no'); ?></td>
          </tr>
      ...
      <div id="tab-product" class="vtabs-content">
        <table class="list" style="max-width:300px;">
          <thead>
            <tr>
          ...
          <tbody>
            <?php $counter = 0; foreach ($products as $product) { $counter += $product['quantity'];?>
            <tr>
          ...
          <tbody id="totals">
            <tr>
              ...
              <td class="left"><?php echo $counter; ?></td>
            </tr>
          </tbody>
