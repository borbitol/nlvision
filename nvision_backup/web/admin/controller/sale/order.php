  ...
  class ControllerSaleOrder extends Controller {
    private $error = array();
      ...
      if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
        ...
        $this->model_sale_order->addOrderSimple($this->request->post);
      ...
      if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
        ...
        $this->model_sale_order->editOrderSimple($this->request->get['order_id'], $this->request->post);
      ...
      $this->data['standards'] = array('Standard 1', 'Standard 2', 'Standard 3');
      
      if (isset($this->request->post['standard'])) {
        $this->data['standard'] = $this->request->post['standard'];
        } elseif (!empty($order_info)) { 
        $this->data['standard'] = $order_info['standard'];
        } else {
        $this->data['standard'] = 'Standard 1';
      }
      ...
      if (isset($this->request->post['need_assistance'])) {
        ...
        $this->data['need_assistance'] = $order_info['need_assistance'];
        } else {
        $this->data['need_assistance'] = 1;
      }
      ...
      $this->template = 'sale/order_form_simple.tpl';
      $this->children = array(
			'common/header',
			'common/footer'
      );
    ...
    public function info() {
      ...
      if ($order_info) {
        ...
        $this->template = 'sale/order_info_simple.tpl';
        $this->children = array(
				'common/header',
				'common/footer'
        );
