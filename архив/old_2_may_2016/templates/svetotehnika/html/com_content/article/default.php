...
<img width="170px"
	...
	src="<?php echo htmlspecialchars($images->image_fulltext); ?>" alt="<?php echo htmlspecialchars($images->image_fulltext_alt); ?>"/> 
            ...
            <img src="templates/svetotehnika/images/lblock_shadow.png" alt="" />
        </div>
	<?php endif; ?>
			
		
<div
<?php if (isset($images->image_fulltext) && !empty($images->image_fulltext)) { } else { ?>
style="margin-left:20px"
<? } ?>
 class="right-block inner item-page<?php echo $this->pageclass_sfx?>">
